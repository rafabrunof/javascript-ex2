...
var novo_grupo = grupos.slice(-2,);
novo_grupo.push(["Mariana", "Felipe", "Carla"]);
...
var curso = {
    ...
    'categoria': ["programação", "categoria", "python"],
    ...
    'n_aval_1_estrela': 4,
    'total_aval' : function() {
        var t_aval = this.n_aval_5_estrelas + this.n_aval_4_estrelas + this.n_aval_3_estrelas + this.n_aval_2_estrelas +
...
var pessoa = {
    'nome': 'Rafael',
    'sobrenome': 'Bruno',
    'email': 'rafabrunofelix@hotmail.com'
}
